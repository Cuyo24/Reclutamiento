...
public class Administrador implements Serializable{
  @Id
    ...
    public Administrador(String id_empleado, String nombre_admin, String apellidop_admin, String apellidom_admin, String correo_admin) {
        this.id_empleado = id_empleado;
        this.nombre_admin = nombre_admin;
        this.apellidop_admin = apellidop_admin;
        this.apellidom_admin = apellidom_admin;
    ...
    public String toString() {
        ...
        sb.append("Personal{id_empleado=").append(id_empleado);
