...
public class AddAdminDto {
    ...
    public AddAdminDto(String id_empleado, String nombre_admin, String apellidop_admin, String apellidom_admin, String correo_admin, String password, ArrayList<AddAdminDto> arrayList) {
    ...
    public String toString() {
        ...
        sb.append("AddAdminDto{id_empleado=").append(id_empleado);
